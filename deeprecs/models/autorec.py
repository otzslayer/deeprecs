...
class Encoder:
    ...
    def forward(self, input_data: torch.Tensor) -> torch.Tensor:
        ...
        """
        return self._encoder(input_data)

    def __repr__(self):
        return repr(self._encoder)

    @property
    def layer(self):
        """Encoder instance의 `_layers` 출력"""
        return self._layers

    @property
    def encoder(self):
        """Encoder instance의 `_encoder` 출력"""
...
class Decoder:
    ...
    def forward(self, input_data: torch.Tensor) -> torch.Tensor:
        ...
        """
        return self._decoder(input_data)

    def __repr__(self):
        return repr(self._decoder)

    @property
    def layer(self):
        """Decoder instance의 `_layers` 출력"""
        return self._layers

    @property
    def decoder(self):
        """Decoder instance의 `_decoder` 출력"""
...
class AutoRec(BaseRecommender):
    ...
    AutoREC논문 :
        https://users.cecs.anu.edu.au/~akmenon/papers/autorec/autorec-paper.pdf
    Melon의 추천 시스템 :
        https://mk.kakaocdn.net/dn/if-kakao/conf2019/발표자료_2019/T08-S01.pdf
    """
    ...
    @property
    def encoder(self):
        """AutoRec instance의 `_encoder` 출력"""
        return self._encoder

    @property
    def decoder(self):
        """AutoRec instance의 `_decoder` 출력"""
        return self._decoder
